                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group-inline">
                                                ...
                                                <input name="date" id="date1" class="form-control" type="date" value="<?php echo $sdate; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group-inline">
                                                ...
                                                <input name="date1" id="date2" class="form-control" placeholder="YYYY-MM-DD" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" type="date" value="<?php echo $edate; ?>">
                                            </div>
                                        </div>
