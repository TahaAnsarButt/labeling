<aside class="page-sidebar">
	<div class="page-logo">
		<a href="<?php echo base_url() ?>dashboard" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
			...
			<span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2">Labeling Stock Management</span>
	...
	<nav id="js-primary-nav" class="primary-nav" role="navigation">
		...
		<ul id="js-nav-menu" class="nav-menu">
			<li>
				<a href="<?php echo base_url('Dashboard/dashboard') ?>" title="Application Intel" data-filter-tags="application intel">
					<i class="fa fa-angle-double-down"></i>
			...
			<li>
				<a href="#" title="Application Intel" data-filter-tags="application intel">
					<i class="fa fa-angle-double-down"></i>
					<span class="nav-link-text" data-i18n="nav.application_intel">Kits Daily Transactions</span>
				</a>
				<ul>

					<li>
						<a href="<?php echo base_url('') ?>kitsReceived" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Kits Receiving</span>
						</a>
					</li>
					<!-- <li>
					...
					<li>
						<a href="<?php echo base_url('') ?>Kitsissuance" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Kits Print</span>
						</a>
					</li>
                    <li>
						<a href="<?php echo base_url('') ?>KitIssuance1" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Printed Label Issuance</span>
						</a>
					</li>


                    <li>
						<a href="<?php echo base_url('') ?>PIR" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Cancel PO Receiving</span>
						</a>
					</li>
                    ...
                    <!-- <li>
						<a href="<?php echo base_url('') ?>Westage/loadWastageForm" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Audit Form</span>
						</a>
					</li>
                    <li>
						<a href="<?php echo base_url('') ?>westage" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Wastage Form</span>
						</a>
					</li>
				 -->
                    
					<!-- <li>
						<a href="<?php echo base_url('') ?>Kitsissuance/report" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Report</span>
						</a>
					</li> -->

					<!-- <li>
                        <a href="<?php echo base_url('') ?>Ledger" title="Introduction" data-filter-tags="application intel introduction">
                            <span class="nav-link-text" data-i18n="nav.application_intel_introduction">Kits Balance</span>
                        </a>
                    </li> -->
					<!-- <li>
						<a href="<?php echo base_url('') ?>PIR" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Printed Inventory Report</span>
						</a>
					</li> -->
                    <!-- <li>
						<a href="<?php echo base_url('') ?>PIR/loadcancelpo" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Canceled PO's</span>
						</a>
					</li>
					 -->
...
<!-- 
                    <li>
						<a href="<?php echo base_url('') ?>WastageRep" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Wastage Reports</span>
						</a>
					</li> -->


                    <!-- <li>
						<a href="<?php echo base_url('') ?>westage1" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Wastage Form 1</span>
						</a>
					</li> -->

					<!-- <li>
						<a href="<?php echo base_url('') ?>westage/Reprinting" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Reprinted Kits</span>

						</a>
					</li> -->
                 
                    <!-- <li>
						<a href="<?php echo base_url('') ?>Kitsissuance/issuanceStock1" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Issuance Stock</span>
						</a>
					</li> -->
            ...
            <li>
				<a href="#" title="Application Intel" data-filter-tags="application intel">
					<i class="fa fa-angle-double-down"></i>
					<span class="nav-link-text" data-i18n="nav.application_intel">Daily Wastage</span>
				</a>
				<ul>
                    <li>
						<a href="<?php echo base_url('') ?>Westage/loadWastageForm" title="Introduction" data-filter-tags="application intel introduction">
                    ...
                    <li>
						<a href="<?php echo base_url('') ?>Westage/AssignAuditM" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Assign Kits Audit Month</span>
						</a>
					</li>
...
<!-- 
					...
					<!-- <li>
						<a href="<?php echo base_url('') ?>Kitsissuance/kitIssue" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Printed Label Issuance</span>
						</a>
					</li> -->
                    ...
                    <li>
						<a href="<?php echo base_url('') ?>Kitsissuance/kitIssue" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Printed Labels Issuance</span>
						</a>
					</li>

                    <li>
						<a href="<?php echo base_url('') ?>westage/Label_Reprinting" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Reprinted Label</span>
						</a>
					</li>
				
                    <li>
						<a href="<?php echo base_url('') ?>PIR/loadcancelpo" title="Introduction" data-filter-tags="application intel introduction">
							<span class="nav-link-text" data-i18n="nav.application_intel_introduction">Cancel PO'S</span>
						</a>
					</li>
