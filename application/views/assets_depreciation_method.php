    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title">Add Asset Depreciation Method</h1>
            </div>
            <div class="modal-body">
                <form name="form" id="myForm" method="POST" action="">
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <div>
                            <input type="text" class="form-control input-lg" id="project-bid"  name="depid">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control input-lg" name="methodName" placeholder="Enter Asset Depreciation Method">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="methodStatus"> Status
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div>
                        <button type="submit" class="btn btn-success" id="saveButtonMethod" >Save</button>
                        <button type="submit" class="btn btn-success" id="updateButtonMethod" style="display:none" >Update</button>   
...
<div class="modal fade" id="ModelDeleteloc" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Delete Depreciation Method Details</h5>
...
<br><br>
                                ...
                                <div id="panel-8" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                        <i class='fal fa fa-table text-primary'></i>&nbsp;&nbsp;Assets Depreciation Method Record 
</span>
                                        </h2>
                                        <button type="button" class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#ModalLoginForm" class="d-grid gap-2 d-md-block" id="createMethod">+ Create</button>
                                    ...
                                    if ($Key['Status'] == 1) {
                                      ...
                                      ?>
                                        ...
                                        ?>    
                                        <td > 
                                        <button  data-value=<?php echo $Key['ID'] ?> data-toggle="modal" data-target="#ModalLoginForm" class="btn btn-primary btn-sm btn-edit-method"><i class="fa fa-pencil-square-o"  style="font-size:20px;"></i> </button>&nbsp;&nbsp;
...
url = '<?php echo base_url('AssetsDepreciationMethod/deleteDepreciation') ?>'
...
$('#createMethod').click(function(e){
    $("#saveButtonMethod").css("display", "inline-block");
    $("#updateButtonMethod").css("display", "none");
    $("#myForm").trigger("reset");
    $('form[name=form]').attr('action','<?php echo base_url('AssetsDepreciationMethod/AddDepreciation') ?>');
});

$('#tableExport').on('click',".btn-edit-method",function(e){
    $("#saveButtonMethod").css("display", "none");
    $("#updateButtonMethod").css("display", "inline-block");
    $('form[name=form]').attr('action','<?php echo base_url('AssetsDepreciationMethod/EditDepreciation') ?>');
        var formData =[];
            llid = $(this).attr('data-value');
      postData = {
        llid
      }
      url = '<?php echo base_url('AssetsDepreciationMethod/getDepreciation') ?>'
      
    $.post(url,postData,
  function(data, status){
    var returnedData = JSON.parse(data);
    console.log(returnedData[0]);
    $("input[name=methodName]").val(returnedData[0].DepresionMethod);
    ...
    $("input[name=depid]").val(returnedData[0].ID);
